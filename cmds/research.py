...
class research(Cog_Extension):
  ...
  async def 科研(self,ctx):
    ...
    placeholder = "科研選擇",
    options =[ 
                    SelectOption(label = "一期", value = "A"),
                    SelectOption(label = "二期", value = "B"),
                    SelectOption(label = "三期", value = "C"),
                    SelectOption(label = "四期", value = "D")
                ]
            )
        ]
  ...
  async def button(self,ctx):
    ...
    [
    Button(label="Button",custom_id="button2"),Button(label="Button",custom_id="button3")]]
    )
